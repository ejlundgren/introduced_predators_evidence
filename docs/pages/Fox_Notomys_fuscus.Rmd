...
Foxes have been documented among a range of ecological variables negatively correlated with dusky hopping mouse abundance in three studies. Causality for decline cannot be inferred due to confounding variables. In contradiction with the claim the extirpation records pre-date the fox arrival record.
<br>
<br>
